...
namespace WebBrowser.Data.HistoryDataSetTableAdapters {
    ...
    public partial class HistoryTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "DELETE FROM [History] WHERE (([Id] = @Original_Id) AND ([Title] = @Original_Title" +
                ") AND ([Date] = @Original_Date))";
            ...
            this._commandCollection[2].CommandText = "SELECT Date, Id, Title, URL FROM History";
        ...
        public virtual int SearchHistory(HistoryDataSet.HistoryDataTable dataTable) {
        ...
        public virtual int DeleteQuery(int Original_Id, string Original_Title, string Original_Date) {
            ...
            if ((Original_Date == null)) {
                ...
                command.Parameters[2].Value = ((string)(Original_Date));
            }
